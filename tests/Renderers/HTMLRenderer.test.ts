    ...
    describe('render()', () => {
        test('should render the state as HTML', () => {
            ...
            const expected: string =  `
                <div class="row">
                    <div class="pixel" data-x="0" data-y="0"></div>
                    <div class="pixel" data-x="1" data-y="0" data-type="T"></div>
                </div>
                <div class="row">
                    <div class="pixel" data-x="0" data-y="1" data-type="T"></div>
                    <div class="pixel" data-x="1" data-y="1"></div>
                </div>
            `.replace(/>\s+</g, '><').trim();
